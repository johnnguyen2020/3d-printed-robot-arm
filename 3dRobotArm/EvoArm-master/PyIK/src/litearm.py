...
class ArmConfig:
    ...
    def __init__(self,
                 ...
                 forearm_length = 165,
                 linkage_length = 150,
                 lower_actuator_length = 45,
                 upper_actuator_length = 45,
                 wrist_length = 100,
                 shoulder_offset = [.1, .1]):
...
class ArmPose:
    ...
    def __init__(self,
        ...
        ##new functions without servo compensation
    def getServoElevator2(self):
        #print(degrees(self.shoulder_angle))
        return degrees(self.shoulder_angle)

    def getServoActuator2(self):
        #print(degrees(self.actuator_angle) + 90)
        return 90 + degrees(self.actuator_angle) 

    def getServoSwing2(self):
        #print(degrees(self.swing_angle))
        return degrees(self.swing_angle)
